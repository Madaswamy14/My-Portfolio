...
const config: Config = {
  title: 'My Portfolio',
  tagline: 'Technical Writer & Planning Manager',
      ...
      links: [
        {
          ...
          items: [
            ...
            { label: 'Documentation Samples', to: '/docs/documentation-samples' },
            { label: 'Jira Getting Started', to: '/docs/jira-getting-started' },
            { label: 'Facebook Quickstart Guide', to: '/docs/facebook-events-quickstart' },
            { label: 'SWAPI API Reference', to: '/docs/swapi-api-reference' },
          ],
        },
        {
          title: 'More',
